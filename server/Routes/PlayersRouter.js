...
import { getTop10Ranks ,getTotalPlayers,getPlayer ,editPlayerBalance ,getPlayerBalance,getPlayerItems,getAllPlayersCharactersInfo,getVipInfo} from '../controllers/PlayersController.js';
...
PlayersRouter.get('/:id', authMiddleware, getPlayer);
PlayersRouter.get('/points/:id', getPlayerBalance);
PlayersRouter.get('/items/:id', authMiddleware, getPlayerItems);                       
